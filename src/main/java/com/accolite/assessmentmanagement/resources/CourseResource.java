...
//        }
    ...
    public void deleteCourse(@PathVariable Long courseId, @AuthenticationPrincipal OAuth2User principal){
        String userId = (String) principal.getAttribute("sub");
        this.courseService.checkUserByIdDeleteCourseById(userId, courseId);
    }
}
